    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!user) {
                    return [2 /*return*/, res.status(401).send({ auth: false, message: 'Unauthorized' })];
                }
                return [4 /*yield*/, comparePasswords(password, user.password_hash)];
            case 2:
                authValid = _a.sent();
                if (!authValid) {
                    return [2 /*return*/, res.status(401).send({ auth: false, message: 'Unauthorized' })];
...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var email, plainTextPassword, user, password_hash, newUser, savedUser, e_1, jwt;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                email = req.body.email;
            ...
            case 1:
                ...
                if (user) {
                    return [2 /*return*/, res.status(422).send({ auth: false, message: 'User may already exist' })];
                }
